...
CREATE_COUNTER(context, lock_socket_read, cpu, ({{"in", "socket"}, {"action", "lock"}, {"lock", "read"}}))
CREATE_COUNTER(context, lock_socket_write, cpu, ({{"in", "socket"}, {"action", "lock"}, {"lock", "write"}}))
